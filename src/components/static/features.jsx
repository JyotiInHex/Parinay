    ...
    <>
      <div className='flex flex-col w-full h-auto mt-5 mb-5 group'>
        ...
        <div className='self-end flex justify-end items-center gap-4'>
          ...
          <div className="flex flex-col gap-2 bg-white w-[22%] h-auto min-h-[22.5em] p-5 border-2 rounded-3xl transition-all cursor-default border-[#007BFF] text-[#007BFF] -translate-y-8">
