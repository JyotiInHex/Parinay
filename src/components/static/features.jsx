    ...
    <>
        <div className='flex flex-col w-full h-auto mt-10'>
            ...
            <div className='self-end flex justify-end items-center gap-4 mb-10'>
              <card className="flex flex-col gap-2 bg-white w-[25%] h-auto p-5 border-2 border-white rounded-3xl transition-all cursor-default hover:border-[#E91E63] hover:text-[#E91E63] hover:-translate-y-8">
              ...
              <card className="flex flex-col gap-2 bg-white w-[25%] h-auto p-5 border-2 border-white rounded-3xl transition-all cursor-default hover:border-[#007BFF] hover:text-[#007BFF] hover:-translate-y-8">
              ...
              <card className="flex flex-col gap-2 bg-white w-[25%] h-auto p-5 border-2 border-white rounded-3xl transition-all cursor-default hover:border-[#4CAF50] hover:text-[#4CAF50] hover:-translate-y-8">
