...
const Features = () => {
  return (
    <>
      <div className='flex flex-col w-full h-auto mt-3 group'>
        <div className='text-2xl text-zinc-400 font-playfair font-semibold underline mb-8 transition-all'>01. Features</div>
