    ...
    <>
      <nav className="grid grid-cols-3 items-center px-14 py-8 bg-[#ffffff15] backdrop-blur-sm w-full h-fit">
        ...
        <ul className="cta flex text-lg font-lato font-semibold justify-self-end gap-3 cursor-pointer">
          <Link to="/register"><li className="buttonEffect-1 w-[6em] border-2 border-zinc-900 rounded-full py-1 text-zinc-900 text-center hover:text-slate-100">Join Now</li></Link>
          <li className="buttonEffect-1 w-[6em] border-2 border-zinc-900 rounded-full py-1 text-zinc-900 text-center hover:text-slate-100" onClick={onLoginClick}>Login</li>
        </ul>
      </nav>
    </>  
  );
