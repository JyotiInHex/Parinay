    ...
    <div className='w-full h-auto mt-[5em] mb-7 bg-[#E91E63] p-10 rounded-3xl'>
        ...
        <div className='grid grid-cols-2 gap-32 h-full'>
          ...
          <div className='flex flex-col gap-12 items-start'>
            ...
            <li className='relative overflow-hidden z-10 border-2 group border-white rounded-full w-fit min-w-[10em] px-6 py-2 text-xl text-slate-50 text-left font-lato font-normal group'><Link to="/learnMore">Learn More <span className='ri-arrow-right-up-line z-[-1] absolute top-0 right-0 translate-x-[0%] translate-y-[0%] w-1 h-1 bg-slate-50 border-2 border-[#E91E63] p-[1.23rem] rounded-full text-[#E91E63] flex items-center justify-center text-2xl transition-all group-hover:rotate-90'></span></Link></li>
          </div>
        </div>
    </div>
  )
