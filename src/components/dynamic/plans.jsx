  ...
  return (
    <>
        <div className='flex flex-wrap justify-center gap-5'>
            <div className='relative overflow-hidden z-10 w-[25%] p-11 flex flex-col rounded-2xl bg-cyan-200 border-4 border-white'>
            ...
            <div className='relative overflow-hidden z-10 w-[25%] p-11 flex flex-col rounded-2xl bg-gray-200 border-4 border-white'>
            ...
            <div className='relative overflow-hidden z-10 w-[25%] p-11 flex flex-col rounded-2xl bg-yellow-200 border-4 border-white'>
            ...
            <div className='relative overflow-hidden z-10 w-[25%] p-11 flex flex-col rounded-2xl bg-violet-200 border-4 border-white'>
