    ...
    <>
        <div className="relative mt-[5em] mb-7">
            <div className="w-full h-auto bg-[#FFF5E1] p-12 flex flex-col gap-6 justify-between">
                ...
                <h2 className="w-[75%] text-5xl text-left text-zinc-900 font-merriweather font-medium leading-relaxed">Embark on your journey to find true love <i className="ri-chat-heart-fill text-[#E91E63]"></i> with Parinay.com. Creating your profile is quick and easy, allowing you to showcase your personality and preferences.</h2>
