    ...
    <>
        <div className="relative mt-[5em] mb-7">
            <div className="w-full h-auto bg-[#FFF5E1] p-12 flex flex-col gap-6 justify-between">
                ...
                <button className="relative z-10 overflow-hidden group border-2 border-[#FF6F61] w-fit h-fit self-end px-8 py-3 rounded-full text-xl text-[#FF6F61] font-lato font-semibold after:transition-all after:absolute after:-bottom-14 after:z-[-1] after:left-0 after:w-full after:h-full after:rounded-[50%] after:bg-white hover:after:-bottom-0 hover:after:rounded-none"><Link to="/register">Begin Your Journey <i className="ri-arrow-right-line transition-all group-hover:ml-4"></i></Link></button>
            </div>
        </div>
    </>
  )
