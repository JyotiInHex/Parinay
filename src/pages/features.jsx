        ...
        <div className="bg-white w-full h-full p-10 rounded-2xl">
          ...
          <ul className="flex flex-wrap gap-x-5 gap-y-9 px-5 mt-10 mb-5">
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              <i className="ri-user-search-line absolute -top-6 left-3 w-8 h-8 p-5 border-2 bg-white flex items-center justify-center rounded-lg text-2xl text-[#4169e1]"></i>
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">01</span>
              <h5 className="text-lg text-[#4169e1] font-lato font-semibold mt-3">Advanced Search Pollutants</h5>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              ...
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">02</span>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              ...
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">03</span>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              ...
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">04</span>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              <i className="ri-user-settings-line absolute -top-6 left-3 w-8 h-8 p-5 border-2 bg-white flex items-center justify-center rounded-lg text-2xl text-[#daa520]"></i>
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">05</span>
              <h5 className="text-lg text-[#daa520] font-lato font-semibold mt-3">Profile Customization</h5>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              ...
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">06</span>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              <i className="ri-hearts-line absolute -top-6 left-3 w-8 h-8 p-5 border-2 bg-white flex items-center justify-center rounded-lg text-2xl text-[#6a5acd]"></i>
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">08</span>
              <h5 className="text-lg text-[#6a5acd] font-lato font-semibold mt-3">Daily Match Recommendations</h5>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              <i className="ri-quill-pen-line absolute -top-6 left-3 w-8 h-8 p-5 border-2 bg-white flex items-center justify-center rounded-lg text-2xl text-[#ff7f50]"></i>
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">09</span>
              <h5 className="text-lg text-[#ff7f50] font-lato font-semibold mt-3">Easy Registration</h5>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              <i className="ri-calendar-event-line absolute -top-6 left-3 w-8 h-8 p-5 border-2 bg-white flex items-center justify-center rounded-lg text-2xl text-[#6495ed]"></i>
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">10</span>
              <h5 className="text-lg text-[#6495ed] font-lato font-semibold mt-3">Events and Conditioning</h5>
            ...
            <li className="relative z-10 w-[49%] h-auto bg-transparent rounded-lg border-2 p-5">
              <i className="ri-customer-service-2-line absolute -top-6 left-3 w-8 h-8 p-5 border-2 bg-white flex items-center justify-center rounded-lg text-2xl text-[#cd5c5c]"></i>
              <span className="pointer-events-none absolute right-3 bottom-0 z-[-1] text-9xl text-slate-100 font-opensans font-semibold">11</span>
              <h5 className="text-lg text-[#cd5c5c] font-lato font-semibold mt-3">Client Support</h5>
