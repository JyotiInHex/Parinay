    ...
    <>
      <div className="w-full h-auto p-5">
        ...
        <div className="bg-white w-full h-full p-10 rounded-2xl text-lg text-zinc-700 font-lato font-medium">
          <h6 className="px-5 text-justify">
          ...
          <div className="flex flex-wrap gap-5 px-5 mb-5">
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#4A90E2]">
              ...
              <h5 className="text-xl text-[#4A90E2] font-lato font-semibold">
                Advanced Search Pollutants
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Narrow down your hunt with customizable pollutants including
                age, position, interests, and more. Find someone who impeccably
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#43A047]">
              ...
              <h5 className="text-xl text-[#43A047] font-lato font-semibold">
                Vindicated Biographies
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Your safety is our precedence. All biographies on Parinay.com
                are vindicated to insure you connect with real and genuine
                individualities.
              </p>
            </div>
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#00bcd4]">
              ...
              <h5 className="text-xl text-[#00bcd4] font-lato font-semibold">
                Smart Matching Algorithm
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                {" "}
                Our intelligent matching algorithm analyses your preferences,
                interests, and gets to suggest compatible matches, adding your
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#FF5252]">
              ...
              <h5 className="text-xl text-[#FF5252] font-lato font-semibold">
                In-App Messaging
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Communicate painlessly with implicit matches through our secure
                and stoner-friendly messaging system. Start exchanges and get to
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#8E24AA]">
              ...
              <h5 className="text-xl text-[#8E24AA] font-lato font-semibold">
                Sequestration and Security
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                We value your sequestration. Parinay.com employs robust security
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#F57C00]">
              ...
              <h5 className="text-xl text-[#F57C00] font-lato font-semibold">
                Artistic Connection
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Engage with a community that shares your artistic background and
                values. share in conversations, share gests, and celebrate
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#8BC34A]">
              ...
              <h5 className="text-xl text-[#8BC34A] font-lato font-semibold">
                Profile Customization
              </h5>
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Show your personality with detailed profile sections. Add
                prints, write about your interests, and punctuate what you ’re
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#4A90E2]">
              ...
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Stay updated with original events and conditioning acclimatized
                for the Assamese community. Join gatherings, meet new people,
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#43A047]">
              ...
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Receive diurnal match recommendations grounded on your
                preferences and exertion, helping you discover implicit mates
            ...
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#00bcd4]">
              ...
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Getting started with Parinay.com is quick and hassle-free.
                subscribe up with just a many way and begin your trip towards
                chancing love.
              </p>
            </div>
            <div className="relative overflow-hidden z-10 w-[32.1%] h-auto mt-4 p-4 rounded-3xl border-2 bg-[#ffffff] drop-shadow-md border-transparent transition-all hover:border-[#FF5252]">
              ...
              <p className="text-lg text-zinc-700 text-shadow-md font-opensans font-normal mt-5">
                Our devoted client support platoon is then to help you with any
                queries or enterprises, icing a smooth and pleasurable
