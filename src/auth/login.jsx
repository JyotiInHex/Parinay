        ...
        <div className="flex flex-row justify-between items-start gap-10">
            ...
            <form className="w-[125vh] bg-white p-7 rounded-lg drop-shadow-lg" action="/login" method="POST">
                ...
                <div className="mb-6 drop-shadow-md">
                    ...
                    <button className="w-full underline text-right text-base text-zinc-500 font-lato font-medium transition-all  hover:text-zinc-600" type="button">Forgot?</button>
                </div>
