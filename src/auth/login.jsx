    ...
    <>
      <div className="relative w-full h-auto text-zinc-700">
        ...
        <div className="flex flex-row justify-between items-start gap-10">
            ...
            <form className="w-[125vh] bg-white p-7 rounded-lg drop-shadow-lg" action="/login" method="POST">
                ...
                <h5 className="mt-3 text-center text-base font-lato font-medium">Don’t have an account? <button type="button" className="font-semibold text-blue-500 transition-all hover:text-blue-700 underline">Register</button></h5>
            </form>
        </div>
